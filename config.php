...
if ($istest) {
    foreach ($_POST as $VarName => $VarValue) {
        echo "POST:$VarName => $VarValue, <BR />";
    };
    foreach ($_GET as $VarName => $VarValue) {
        echo "GET:$VarName => $VarValue, <BR />";
    };
    echo "<BR/>";
}
...
<HEAD><TITLE>Tickets - Configuration Module</TITLE>
    ...
    <STYLE>
        ...
        * html #bar { /*\*/
            ...
            right: expression((320 + (ignoreMe2 = document.documentElement.scrollLeft ? document.documentElement.scrollLeft : document.body.scrollLeft)) + 'px'); /**/
        }
    ...
    <SCRIPT>
        ...
        function validate_cen(theForm) {			// Map center  validation
            ...
            if (theForm.frm_map_caption.value == "") {
                errmsg += "\tMap caption is required.\n";
            }
            if (errmsg != "") {
...
//		if (theForm.gmaps_api_key.value.length!=86)			{errmsg+= "\tInvalid GMaps API key\n";}	// 3/4/12
    ...
    if (mysql_num_rows($result) > 0) {
        ...
        while ($row = stripslashes_deep(mysql_fetch_array($result))) {
            ...
            print "<TD CLASS='td_data text' ALIGN='center'><INPUT TYPE='checkbox' VALUE='1' NAME='frm_on_action[$i]'";
            print $row['on_action'] ? " checked DISABLED /></TD>\n" : " DISABLED /></TD>\n";
            print "<TD CLASS='td_data text' ALIGN='center'><INPUT TYPE='checkbox' VALUE='1' NAME='frm_on_patient[$i]'";
            print $row['on_patient'] ? " checked DISABLED /></TD>\n" : " DISABLED /></TD>\n";
            print "<TD CLASS='td_data text' ALIGN='center'><INPUT TYPE='checkbox' VALUE='1' NAME='frm_on_ticket[$i]'";
            print $row['on_ticket'] ? " checked DISABLED/></TD>\n" : " DISABLED /></TD>\n";
        ...
        <DIV id='button_bar' class='but_container'>
							...
							<SPAN ID='sub_but' class='plain text'
                                  ...
                                  onClick='validate(document.notify_form);'><SPAN
                                    STYLE='float: left;'><?php print get_text("Next"); ?></SPAN><IMG
                    ...
                    <TABLE BORDER="0" STYLE='margin-left:80px'>
                        <FORM METHOD="POST" NAME="notify_form" ACTION="config.php?func=notify&add=true">
                            ...
                            <TR CLASS='odd'>
                                ...
                                <TD>
                                    <INPUT MAXLENGTH="150" SIZE="40" TYPE="text" NAME="frm_execute"
                                           VALUE="" <?php print $dis; ?> />
                                </TD>
                            </TR>
                            <TR CLASS='even'>
                                ...
                                <TD ALIGN="left">
                                    &nbsp;&nbsp;&nbsp;&nbsp;Action&nbsp;&raquo;<INPUT TYPE="checkbox" VALUE="1"
                                                                                      NAME="frm_on_action">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Patient&raquo;<INPUT TYPE="checkbox"
                                                                                                         VALUE="1"
                                                                                                         NAME="frm_on_patient">
                                </TD>
                            </TR>
                                ...
                                <TR CLASS='odd'>
                                    <TD COLSPAN=2 ALIGN="center"><BR/>
                                        <SPAN id='can_but' class='plain text'
                                              ...
                                              onMouseOver='do_hover(this.id); Tip("Cancel & close window");'
                                              onMouseOut='do_plain(this.id); UnTip();'
...
exit();
    ...
    if (mysql_num_rows($result)) {
        ...
        while ($row = stripslashes_deep(mysql_fetch_array($result))) {
            ...
            print "<TD ALIGN='center'><INPUT TYPE='checkbox' VALUE='1' NAME='frm_on_action[$i]'";
            print $row['on_action'] ? " checked></TD>\n" : "></TD>\n";
            print "<TD ALIGN='center'><INPUT TYPE='checkbox' VALUE='1' NAME='frm_on_patient[$i]'";
            print $row['on_patient'] ? " checked></TD>\n" : "></TD>\n";
            print "<TD ALIGN='center'><INPUT TYPE='checkbox' VALUE='1' NAME='frm_on_ticket[$i]'";
            print $row['on_ticket'] ? " checked></TD>\n" : "></TD>\n";
        ...
        <DIV STYLE='margin-left:100px;margin-top:50px;'>
            ...
            <FORM NAME='new_notify' method='GET' ACTION='<?php echo basename(__FILE__); ?>'>
                <INPUT TYPE='hidden' NAME='func' VALUE='notify'/>
                <INPUT TYPE='hidden' NAME='id' VALUE='0'/>
                <SPAN id='new_but' CLASS='plain text' style='width: 100px; display: inline-block; float: none;'
                      onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                      onClick="document.new_notify.submit();"><SPAN
                        STYLE='float: left;'><?php print get_text("New Notify"); ?></SPAN><IMG STYLE='float: right;'
                                                                                               SRC='./images/plus_small.png'
                                                                                               BORDER=0></SPAN>
            </FORM>
        </DIV>
        </BODY></HTML>
...
case 'profile' :                    //update profile
    ...
    if ($get_go == 'true') {            //check passwords
        ...
        <BR/>
        <BR/>
        <FORM METHOD="POST" name='editProf' ACTION="config.php?func=profile&go=true"><INPUT TYPE="hidden" NAME="frm_id"
            ...
            <TABLE BORDER="0" STYLE=' width: 50%; margin-left:40px'>
                ...
                <TR CLASS="even">
                    ...
                    <TD style='width: 50%;'>
                        <SPAN class='plain' id='gen_pass' style='vertical-align: middle; float: left;'
                              onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                              onClick='generatePassword();'>Generate Password</SPAN>
                        <SPAN id='view_password' class='text_large text_bold text_valign_middle text_center'
                              style='float: right; display: none; background-color: #FFFFFF; border: 1px outset #707070; height: 100%; width: 50%;'></SPAN>
                    </TD>
                </TR>
                <TR CLASS="odd">
                    <TD CLASS="td_label text" style='width: 25%;'>Email:</TD>
                    <TD COLSPAN=3 style='width: 75%;'>
                        <INPUT SIZE="47" MAXLENGTH="255" TYPE="text" VALUE="<?php print $row['email']; ?>"
                               NAME="frm_email">
                    </TD>
                </TR>
                <TR CLASS="even">
                    ...
                    <TD COLSPAN=3 style='width: 75%;'>
                        <INPUT SIZE="47" MAXLENGTH="255" TYPE="text" VALUE="<?php print $row['info']; ?>"
                               NAME="frm_info">
                    </TD>
                </TR>
                <TR CLASS="odd">
                    ...
                    <TD COLSPAN=3 style='width: 75%;'>
                        <INPUT SIZE="47" MAXLENGTH="3" TYPE="text" VALUE="<?php print $row['ticket_per_page']; ?>"
                               NAME="frm_ticket_per_page">
                    </TD>
                </TR>
                <TR CLASS="even">
                    ...
                    <TD COLSPAN=3 style='width: 75%;'>
                        <SELECT NAME="frm_sortorder">
                            <OPTION value="date" <?php if ($row['sortorder'] == 'date') print " selected"; ?>>Date
                            </OPTION>
                            <OPTION
                                value="description" <?php if ($row['sortorder'] == 'description') print " selected"; ?>>
                                Description
                            </OPTION>
                            <OPTION value="affected" <?php if ($row['sortorder'] == 'affected') print " selected"; ?>>
                                Affected
                            </OPTION>
                        </SELECT>&nbsp;
                        Descending
                        <INPUT TYPE="checkbox" value="1"
                               name="frm_sort_desc" <?php if ($row['sort_desc']) print "checked"; ?>>
                    </TD>
                </TR>
                <TR CLASS="odd">
                    <TD COLSPAN=4 ALIGN="center" COLSPAN=2 style='width: 100%;'>
                        <SPAN id='can_but' CLASS='plain text' style='width: 100px; display: inline-block; float: none;'
                              onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                              onClick="document.can_Form.submit();"><SPAN
                                STYLE='float: left;'><?php print get_text("Cancel"); ?></SPAN><IMG STYLE='float: right;'
                                                                                                   ...
                                                                                                   BORDER=0></SPAN>
                        <SPAN id='reset_but' CLASS='plain text'
                              style='width: 100px; display: inline-block; float: none;' onMouseover='do_hover(this.id);'
                              onMouseout='do_plain(this.id);' onClick="document.editProf.reset();"><SPAN
                                STYLE='float: left;'><?php print get_text("Reset"); ?></SPAN><IMG STYLE='float: right;'
                                                                                                  SRC='./images/restore_small.png'
                                                                                                  BORDER=0></SPAN>
                        <SPAN id='sub_but' CLASS='plain text' style='width: 100px; display: inline-block; float: none;'
                              onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                              onClick="validate_prof(document.editProf);"><SPAN
        ...
        <SCRIPT>
            ...
            function validate(theForm) {						//profile validation	- 10/23/08
                ...
                if (theForm.frm_passwd.value.trim() != theForm.frm_passwd_confirm.value.trim()) {
                    errmsg += "\tPasswd and confirmation must match.\n";
                }
                if (theForm.frm_email.value.trim().length > 0) {
                    if (!validate_email(theForm.frm_email.value.trim())) {
                        errmsg += "\tValid email format is required.\n";
                    }
                }
...
case 'reset' :
    if ((isset($_GET['auth'])) && ($_GET['auth'] == 'true') && ($_POST['frm_confirm'] == 'yes')) {
        ...
        <DIV STYLE='position: relative; left: 100px;'>
            ...
            <FONT CLASS="warn"><BR/>Warning! This deletes all previous tickets, actions, patients, users, resets<BR/>
                settings and creates a default admin user.</FONT><BR/><BR/>
        </DIV>
                ...
                <TR>
                    ...
                    <TD ALIGN="center">
                        <SPAN id='cancel_but' CLASS='plain text'
                              style='float: none; width: 100px; display: inline-block;' onMouseover='do_hover(this.id);'
                              onMouseout='do_plain(this.id);' onClick="history.back();"><SPAN
                                STYLE='float: left;'><?php print get_text("Cancel"); ?></SPAN><IMG STYLE='float: right;'
                                                                                                   SRC='./images/cancel_small.png'
                                                                                                   BORDER=0></SPAN>
                        <SPAN id='reset_but' CLASS='plain text'
                              style='float: none; width: 100px; display: inline-block;' onMouseover='do_hover(this.id);'
                              onMouseout='do_plain(this.id);' onClick="document.resetDB.reset();"><SPAN
                                STYLE='float: left;'><?php print get_text("Reset"); ?></SPAN><IMG STYLE='float: right;'
                                                                                                  SRC='./images/restore_small.png'
                                                                                                  BORDER=0></SPAN>
                        <SPAN id='send_but' CLASS='plain text' style='width: 100px; display: inline-block; float: none;'
                              onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                              onClick="document.resetDB.submit();"><SPAN
                                STYLE='float: left;'><?php print get_text("Apply"); ?></SPAN><IMG STYLE='float: right;'
                                                                                                  SRC='./images/submit_small.png'
                                                                                                  BORDER=0></SPAN>
                    </TD>
                </TR>
...
case 'settings' :
    if ((isset($_GET)) && (isset($_GET['go'])) && ($_GET['go'] == 'true')) {
        ...
        <DIV ID='to_bottom' style="position:fixed; top:4px; left:20px; height: 12px; width: 10px;"
             onclick="location.href = '#bottom';"><IMG SRC="markers/down.png" BORDER=0/></div>
        <A NAME="top"/> <!-- 11/11/09 -->
        ...
        <DIV ID="foo">
            <DIV ID="bar">        <!-- 9/26/09 -->
                <SPAN id='cancel_but' CLASS='plain text' style='float: left; width: 100px; display: inline-block;'
                      onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                      onClick="document.can_Form.submit();"><SPAN
                        STYLE='float: left;'><?php print get_text("Cancel"); ?></SPAN><IMG STYLE='float: right;'
                                                                                           SRC='./images/cancel_small.png'
                ...
                if ((is_administrator()) || (is_super())) {
                    ?>
                    <SPAN id='reset_but' CLASS='plain text' style='float: left; width: 100px; display: inline-block;'
                          onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                          onClick="document.set_Form.reset();"><SPAN
                            STYLE='float: left;'><?php print get_text("Reset"); ?></SPAN><IMG STYLE='float: right;'
                                                                                              SRC='./images/restore_small.png'
                                                                                              BORDER=0></SPAN>
                    <SPAN id='sub_but' CLASS='plain text' style='width: 100px; display: inline-block; float: left;'
                          onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                          onClick="document.set_Form.submit();"><SPAN
                            STYLE='float: left;'><?php print get_text("Submit"); ?></SPAN><IMG STYLE='float: right;'
                                                                                               SRC='./images/submit_small.png'
                                                                                               BORDER=0></SPAN>
                    <?php
...
case 'wizard_settings' :
    if ((isset($_GET)) && (isset($_GET['go'])) && ($_GET['go'] == 'true')) {
        ...
        if (array_key_exists('frm_delete', $_POST)) {
            ...
            if ($delcounter > 0) {
                print $delcounter . " Field Settings removed from New Incident Wizard.";
            }
        }
        ...
        while ($row = stripslashes_deep(mysql_fetch_array($result))) {
            ...
            if ($name == "address") {
                ...
                $fieldindex = get_field_index("ticket", $name);
            }
            if ($name == "address") {
                $type = "STRING";
            } else {
        ...
        <DIV ID="foo">
            <DIV ID="bar">        <!-- 9/26/09 -->
                ...
                if ((is_administrator()) || (is_super())) {
                    ...
                    <SPAN id='reset_but' CLASS='plain text' style='float: left; width: 100px; display: inline-block;'
                          onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                          onClick="do_reset_settings();"><SPAN
                            STYLE='float: left;'><?php print get_text("Reset"); ?></SPAN><IMG STYLE='float: right;'
                                                                                              SRC='./images/restore_small.png'
                                                                                              BORDER=0></SPAN>
                    <SPAN id='sub_but' CLASS='plain text' style='width: 100px; display: inline-block; float: left;'
...
case 'user' :
    ...
    if ((array_key_exists('id', ($_GET))) && ($_GET['id'] != '')) {
        if (is_administrator()) {                // admin or super
            ...
            <FORM METHOD="POST" NAME="user_add_Form" onSubmit="return validate_user(document.user_add_Form);"
                  ACTION="config.php?func=user&edit=true">
                ...
                <TABLE BORDER="0" CELLSPACING=1 STYLE='width: 50%;'>
                    <TR CLASS="even">
                        ...
                        <TD COLSPAN=3>
                            <INPUT MAXLENGTH="20" SIZE="20" TYPE="text" VALUE="<?php print $row['user']; ?>"
                                   NAME="frm_user" <?php print $disabled; ?> />
                        </TD>
                    </TR>
                    <TR CLASS="odd">
                        <TD ALIGN="right" CLASS="td_label text">Password:</TD>
                        <TD COLSPAN=2>
                            <INPUT MAXLENGTH="20" SIZE="20" TYPE="password"
                                   NAME="frm_passwd" <?php print $disabled; ?> /> &nbsp;&nbsp;<B>Confirm: </B>
                            <INPUT MAXLENGTH="255" SIZE="16" TYPE="password"
                                   NAME="frm_passwd_confirm" <?php print $disabled; ?> />
                            &nbsp;&nbsp;<SPAN class='plain' id='gen_pass' style='vertical-align: middle; float: right;'
                                              onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                                              onClick='generatePassword();'>Generate Password</SPAN>
                        </TD>
                        <TD>
                            <SPAN id='view_password' class='text_large text_bold text_valign_middle text_center'
                                  style='float: right; display: none; background-color: #FFFFFF; border: 1px outset #707070; height: 100%; width: 100%;'></SPAN>
                        </TD>
                    </TR>
                    ...
                    <TR VALIGN="baseline" CLASS="odd">
                        ...
                        <TD>
                            <INPUT ID="ID3" MAXLENGTH="32" SIZE=32 type="text" NAME="frm_name_l"
                                   VALUE="<?php print $row['name_l']; ?>"
                                   onChange="this.value=this.value.trim()"<?php print $disabled; ?>>
                        </TD>
                        <TD CLASS="td_label text" ALIGN="right">First:</TD>
                        <TD>
                            <INPUT ID="ID4" MAXLENGTH="32" SIZE=32 type="text" NAME="frm_name_f"
                                   VALUE="<?php print $row['name_f']; ?>"
                                   onChange="this.value=this.value.trim()"<?php print $disabled; ?>>
                        </TD>
                    </TR>
                    ...
                    <TR VALIGN="baseline" CLASS="odd">
                        ...
                        <TD>
                            <INPUT ID="ID5" MAXLENGTH="4" SIZE=3 type="text" NAME="frm_name_mi"
                                   VALUE="<?php print $row['name_mi']; ?>"
                                   onChange="this.value=this.value.trim()"<?php print $disabled; ?> />
                        </TD>
                        <TD CLASS="td_label text" ALIGN="right">DOB:</TD>
                        <TD>
                            <INPUT MAXLENGTH=16 ID="fd6" SIZE=16 type="text" NAME="frm_dob"
                                   VALUE="<?php print $row['dob']; ?>"
                                   onChange="this.value=this.value.trim()"<?php print $disabled; ?> />
                        </TD>
                    </TR>
                    <TR CLASS="even">
                        ...
                        <TD>
                            <INPUT SIZE="20" MAXLENGTH="20" TYPE="text" NAME="frm_callsign"
                                   VALUE="<?php print $row['callsign']; ?>"<?php print $disabled; ?> />
                        </TD>
                        <TD CLASS="td_label text" ALIGN="right">Ident:</TD>
                        <TD>
                            <INPUT ID="ID17" MAXLENGTH="32" SIZE=32 type="text" NAME="frm_ident"
                                   VALUE="<?php print $row['ident']; ?>"
                                   onChange="this.value=this.value.trim()"<?php print $disabled; ?> />
                        </TD>
                    </TR>
                    <TR CLASS="odd">
                        ...
                        <TD COLSPAN=3>
                            <INPUT SIZE="83" MAXLENGTH="83" TYPE="text" NAME="frm_info"
                                   VALUE="<?php print $row['info']; ?>"<?php print $disabled; ?>>
                        </TD>
                    </TR>
                    <TR CLASS="even">
                        <TD CLASS="td_label text" ALIGN="right">Email:</TD>
                        <TD>
                            <INPUT SIZE="32" MAXLENGTH="128" TYPE="text" NAME="frm_email"
                                   VALUE="<?php print $row['email']; ?>"<?php print $disabled; ?> />
                        </TD>
                        <TD CLASS="td_label text" ALIGN="right">&nbsp;&nbsp;&nbsp;&nbsp;Alternate:</TD>
                        <TD>
                            <INPUT ID="ID24" MAXLENGTH="32" SIZE="32" type="text" NAME="frm_email_s"
                                   VALUE="<?php print $row['email_s']; ?>"
                                   onChange="this.value=this.value.trim()"<?php print $disabled; ?> />
                        </TD>
                    </TR>
                    <TR VALIGN="baseline" CLASS="odd">
                        <TD CLASS="td_label text" ALIGN="right"> Street addr:</TD>
                        <TD COLSPAN=4>
                            <INPUT ID="ID8" MAXLENGTH="32" SIZE=32 type="text" NAME="frm_addr_street"
                                   VALUE="<?php print $row['addr_street']; ?>"
                                   onChange="this.value=this.value.trim()"<?php print $disabled; ?>>
                        </TD>
                    </TR>
                    <TR VALIGN="baseline" CLASS="even">
                        ...
                        <TD>
                            <INPUT ID="ID9" MAXLENGTH="32" SIZE="32" type="text" NAME="frm_addr_city"
                                   VALUE="<?php print $row['addr_city']; ?>"
                                   onChange="this.value=this.value.trim()"<?php print $disabled; ?>>
                        </TD>
                        <TD CLASS="td_label text" ALIGN="right">St:</TD>
                        <TD>
                            <INPUT ID="ID10" MAXLENGTH="<?php print $st_size; ?>" SIZE="<?php print $st_size; ?>"
                                   type="text" NAME="frm_addr_st" VALUE="<?php print $row['addr_st']; ?>"
                                   onChange="this.value=this.value.trim()"<?php print $disabled; ?>>
                        </TD>
                    </TR>
                    <TR VALIGN="baseline" CLASS="odd">
                        ...
                        <TD>
                            <INPUT ID="ID19" MAXLENGTH="32" SIZE="32" type="text" NAME="frm_phone_p"
                                   VALUE="<?php print $row['phone_p']; ?>"
                                   onChange="this.value=this.value.trim()"<?php print $disabled; ?> />
                        </TD>
                        <TD CLASS="td_label text" ALIGN="right">Alternate:</TD>
                        <TD>
                            <INPUT ID="ID20" MAXLENGTH="32" SIZE="32" type="text" NAME="frm_phone_s"
                                   VALUE="<?php print $row['phone_s']; ?>"
                                   onChange="this.value=this.value.trim()"<?php print $disabled; ?> />
                        </TD>
                    </TR>
                    <TR VALIGN="baseline" CLASS="even">
                        ...
                        <TD COLSPAN=3>
                            <INPUT ID="ID21" MAXLENGTH="32" SIZE="32" type="text" NAME="frm_phone_m"
                                   VALUE="<?php print $row['phone_m']; ?>"
                                   onChange="this.value=this.value.trim()"<?php print $disabled; ?>>
                        </TD>
                    </TR>
                    <?php
                    if ((is_administrator() || is_super())) {
                        ...
                        <TR CLASS="odd" VALIGN='top'>
                            ...
                            <TD COLSPAN=3>
                                &raquo; <INPUT TYPE="checkbox" VALUE="yes"
                                               NAME="frm_remove" <?php print $disabled; ?> />
                            </TD>
                        </TR>
                        <?php
                    }
                        ...
                        <TD COLSPAN=3 ALIGN="center">
                            ...
                            if ($disabled != "DISABLED") {
                                ...
                                <SPAN id='cancel_but' CLASS='plain text'
                                      ...
                                      onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                                      onClick="document.can_Form.submit();"><SPAN
                                        STYLE='float: left;'><?php print get_text("Back"); ?></SPAN><IMG
                                        STYLE='float: right;' SRC='./images/back_small.png' BORDER=0></SPAN>
                                <?php
                            }
                            if ((is_administrator() || is_super())) {
                                if ($disabled != "DISABLED") {
                                    ...
                                    <SPAN id='reset_but' CLASS='plain text'
                                          style='float: none; width: 100px; display: inline-block;'
                                          onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                                          onClick="document.user_add_Form.reset(); document.user_add_Form.frm_responder_id.value='<?php echo $row['responder_id']; ?>'; document.user_add_Form.frm_facility_id.value='<?php echo $row['facility_id']; ?>';"><SPAN
                                            STYLE='float: left;'><?php print get_text("Reset"); ?></SPAN><IMG
                                            STYLE='float: right;' SRC='./images/restore_small.png' BORDER=0></SPAN>
                                    <SPAN id='sub_but' CLASS='plain text'
                                          style='float: none; width: 100px; display: inline-block;'
                                          onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                                          onClick="return validate_user(document.user_add_Form);"><SPAN
                                            STYLE='float: left;'><?php print get_text("Submit"); ?></SPAN><IMG
                                            STYLE='float: right;' SRC='./images/submit_small.png' BORDER=0></SPAN>
                                    <?php
                                }
        ...
        if (is_administrator()) {
            if ((array_key_exists('go', ($_GET))) && ($_GET['go'] == 'true')) {
                if ($_POST['frm_passwd'] == $_POST['frm_passwd_confirm']) {                        // 11/30/08
                    ...
                    <BR/>
                    <FORM METHOD="POST" NAME="user_add_Form" onSubmit="return validate_user(document.user_add_Form);"
                          ACTION="config.php?func=user&add=true&go=true">
                        <TR CLASS="even">
                            <TABLE BORDER="0">
                        ...
                        <TR CLASS="even">
                            <TD CLASS="td_label text">Level:</TD>
                            <TD>
                                <?php
                                if (is_super()) {                // 6/9/08
                                    ?>
                                    <INPUT TYPE="radio" VALUE="<?php print $GLOBALS['LEVEL_SUPER']; ?>"
                                           NAME="frm_level" <?php print is_super() ? "checked" : ""; ?>> Super<BR/>
                                    <?php
                                }
                                ?>
                                <INPUT TYPE="radio" VALUE="<?php print $GLOBALS['LEVEL_ADMINISTRATOR']; ?>"
                                       NAME="frm_level" <?php print is_administrator() ? "checked" : ""; ?>>
                                Administrator<BR/>
                                <INPUT TYPE="radio" VALUE="<?php print $GLOBALS['LEVEL_USER']; ?>"
                                       NAME="frm_level" <?php print is_user() ? "checked" : ""; ?>> Operator<BR/>
                                <INPUT TYPE="radio" VALUE="<?php print $GLOBALS['LEVEL_GUEST']; ?>"
                                       NAME="frm_level" <?php print is_guest() ? "checked" : ""; ?>> Guest<BR/>
                                <INPUT TYPE="radio" VALUE="<?php print $GLOBALS['LEVEL_MEMBER']; ?>"
                                       NAME="frm_level" <?php print is_member() ? "checked" : ""; ?>> Member<BR/>
                                <INPUT TYPE="radio" VALUE="<?php print $GLOBALS['LEVEL_UNIT']; ?>"
                                       NAME="frm_level" <?php print is_unit() ? "checked" : ""; ?>> Unit<BR/>
                                <INPUT TYPE="radio" VALUE="<?php print $GLOBALS['LEVEL_FACILITY']; ?>"
                                       NAME="frm_level" <?php print is_facility() ? "checked" : ""; ?>> Facility<BR/>
                                <INPUT TYPE="radio" VALUE="<?php print $GLOBALS['LEVEL_STATISTICS']; ?>"
                                       NAME="frm_level" <?php print is_statistics() ? "checked" : ""; ?>>
                                Statistics<BR/>
                                <INPUT TYPE="radio" VALUE="<?php print $GLOBALS['LEVEL_SERVICE_USER']; ?>"
                                       NAME="frm_level" <?php print is_service_user() ? "checked" : ""; ?>> Service User<BR/>
                            </TD>
                        </TR>
                        <TR CLASS="odd">
                        ...
                        <TR CLASS="even">
                            ...
                            <TD>
                                ...
                                <SPAN id='reset_but' CLASS='plain text'
                                      style='float: none; width: 100px; display: inline-block;'
                                      onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                                      onClick="document.user_add_Form.reset();"><SPAN
                                        STYLE='float: left;'><?php print get_text("Reset"); ?></SPAN><IMG
                                        STYLE='float: right;' SRC='./images/restore_small.png' BORDER=0></SPAN>
                                <SPAN id='sub_but' CLASS='plain text'
                                      style='float: none; width: 100px; display: inline-block;'
                ...
                <FORM METHOD="POST" NAME="user_add_Form" onSubmit="return validate_user(document.user_add_Form);"
                    ...
                    <TABLE BORDER=0 CELLSPACING=1>
                        ...
                        <TR CLASS="odd">
                            ...
                            <TD COLSPAN=2>
                                <INPUT MAXLENGTH="20" SIZE="20" TYPE="password" NAME="frm_passwd" VALUE=""/>&nbsp;&nbsp;
                                <B>Confirm: </B>
                        ...
                        <TR CLASS="even" VALIGN='baseline'>
                            ...
                            <TD COLSPAN=3>&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                if (is_super()) {
                                    ?>
                                    Super  &raquo;<INPUT TYPE="radio" VALUE="<?php print $GLOBALS['LEVEL_SUPER']; ?>"
                                                         NAME="frm_level" <?php print $onclick; ?>>&nbsp;&nbsp;&nbsp;
                                    <?php
                                }
                                ?>
                                Admin &raquo; <INPUT TYPE="radio"
                                                     VALUE="<?php print $GLOBALS['LEVEL_ADMINISTRATOR']; ?>"
                                                     NAME="frm_level" <?php print $onclick; ?>/>&nbsp;&nbsp;
                                Operator &raquo; <INPUT TYPE="radio" VALUE="<?php print $GLOBALS['LEVEL_USER']; ?>"
                                                        NAME="frm_level" <?php print $onclick; ?>/>&nbsp;&nbsp;
                                Guest &raquo; <INPUT TYPE="radio" VALUE="<?php print $GLOBALS['LEVEL_GUEST']; ?>"
                                                     NAME="frm_level" <?php print $onclick; ?>/> &nbsp;&nbsp;
                                Member &raquo; <INPUT TYPE="radio" VALUE="<?php print $GLOBALS['LEVEL_MEMBER']; ?>"
                                                      NAME="frm_level" <?php print $onclick; ?>/>    <!-- 3/3/09 -->
                                <?php print get_text("Unit"); ?> &raquo; <INPUT TYPE="radio"
                                                                                VALUE="<?php print $GLOBALS['LEVEL_UNIT']; ?>"
                                                                                NAME="frm_level" <?php print $on_responder; ?>/>
                                <!-- 6/30/09 -->
                                <?php print get_text("Facility"); ?> &raquo; <INPUT TYPE="radio"
                                                                                    VALUE="<?php print $GLOBALS['LEVEL_FACILITY']; ?>"
                                                                                    NAME="frm_level" <?php print $on_facility; ?>/>
                                <!-- 4/7/16 -->
                                Statistics &raquo; <INPUT TYPE="radio" VALUE="<?php print $GLOBALS['LEVEL_STATS']; ?>"
                                                          NAME="frm_level" <?php print $onclick; ?>/> <!-- 7/6/11 -->
                                Service User &raquo; <INPUT TYPE="radio"
                                                            VALUE="<?php print $GLOBALS['LEVEL_SERVICE_USER']; ?>"
                                                            NAME="frm_level" <?php print $onclick; ?>/>
                            </TD>
                        </TR>
                        <?php
                        ...
                        <TR VALIGN="baseline" CLASS="even">
                            <TD id="unit_sel" CLASS="td_label text" style='display: none;'
                                ALIGN="right"><?php print get_text("Units"); ?>:
                            </TD>
                            <TD><?php print $sel_str; ?></TD>
                        </TR>
                        <TR VALIGN="baseline" CLASS="odd">
                            <TD id="fac_sel" CLASS="td_label text" style='display: none;'
                                ALIGN="right"><?php print get_text("Facility"); ?>:
                            </TD>
                        ...
                        <TR VALIGN="baseline" CLASS="odd">
                            <TD CLASS="td_label text" ALIGN="right">Last name:</TD>
                            <TD><INPUT ID="ID3" MAXLENGTH="32" SIZE=32 type="text" NAME="frm_name_l" VALUE=""
                                       onChange="this.value=this.value.trim()"></TD>
                            <TD CLASS="td_label text" ALIGN="right">First:</TD>
                            <TD><INPUT ID="ID4" MAXLENGTH="32" SIZE=32 type="text" NAME="frm_name_f" VALUE=""
                                       onChange="this.value=this.value.trim()"></TD>
                        </TR>
                        <TR VALIGN="baseline" CLASS="even">
                            <TD CLASS="td_label text" ALIGN="right">
                        ...
                        <TR VALIGN="baseline" CLASS="odd">
                            <TD CLASS="td_label text" ALIGN="right">MI:</TD>
                            <TD><INPUT ID="ID5" MAXLENGTH="4" SIZE=3 type="text" NAME="frm_name_mi" VALUE=""
                                       onChange="this.value=this.value.trim()"></TD>
                            <TD CLASS="td_label text" ALIGN="right">DOB:</TD>
                            <TD><INPUT MAXLENGTH=16 ID="fd6" SIZE=16 type="text" NAME="frm_dob" VALUE=""
                                       onChange="this.value=this.value.trim()"/></TD>
                        </TR>
                        <TR CLASS="even">
                            <TD CLASS="td_label text" ALIGN="right">Callsign:</TD>
                            ...
                            <TD CLASS="td_label text" ALIGN="right">Ident:</TD>
                            <TD><INPUT ID="ID17" MAXLENGTH="32" SIZE=32 type="text" NAME="frm_ident" VALUE=""
                                       onChange="this.value=this.value.trim()"></TD>
                        </TR>
                        <TR CLASS="odd">
                            <TD CLASS="td_label text" ALIGN="right">Info:</TD>
                        ...
                        <TR CLASS="even">
                            ...
                            <TD CLASS="td_label text" ALIGN="right">Alternate:</TD>
                            <TD><INPUT ID="ID24" SIZE="32" MAXLENGTH="128" type="text" NAME="frm_email_s" VALUE=""
                                       onChange="this.value=this.value.trim()"></TD>
                        </TR>
                        <TR VALIGN="baseline" CLASS="odd">
                            <TD CLASS="td_label text" ALIGN="right"> Street addr:</TD>
                            <TD COLSPAN=3><INPUT ID="ID8" MAXLENGTH="32" SIZE=32 type="text" NAME="frm_addr_street"
                                                 VALUE="" onChange="this.value=this.value.trim()"></TD>
                        </TR>
                        <TR VALIGN="baseline" CLASS="even">
                            <TD CLASS="td_label text" ALIGN="right">City:</TD>
                            <TD><INPUT ID="ID9" MAXLENGTH="32" SIZE="32" type="text" NAME="frm_addr_city" VALUE=""
                                       onChange="this.value=this.value.trim()"></TD>
                            <TD CLASS="td_label text" ALIGN="right">St:</TD>
                            <TD><INPUT ID="ID10" MAXLENGTH="<?php print $st_size; ?>" SIZE="<?php print $st_size; ?>"
                                       type="text" NAME="frm_addr_st" VALUE="" onChange="this.value=this.value.trim()">
                            </TD>
                        </TR>
                        <TR VALIGN="baseline" CLASS="odd">
                            <TD CLASS="td_label text" ALIGN="right">Phone:</TD>
                            <TD><INPUT ID="ID19" MAXLENGTH="32" SIZE="32" type="text" NAME="frm_phone_p" VALUE=""
                                       onChange="this.value=this.value.trim()"></TD>
                            <TD CLASS="td_label text" ALIGN="right">Alternate:</TD>
                            <TD><INPUT ID="ID20" MAXLENGTH="32" SIZE="32" type="text" NAME="frm_phone_s" VALUE=""
                                       onChange="this.value=this.value.trim()"></TD>
                        </TR>
                        <TR VALIGN="baseline" CLASS="even">
                            <TD CLASS="td_label text" ALIGN="right">Mobile:</TD>
                            <TD COLSPAN=3><INPUT ID="ID21" MAXLENGTH="32" SIZE="32" type="text" NAME="frm_phone_m"
                                                 VALUE="" onChange="this.value=this.value.trim()"></TD>
                        </TR>
                        ...
                        <TR CLASS="odd">
                            <TD COLSPAN=4 ALIGN="center">
                                ...
                                <SPAN id='reset_but' CLASS='plain text'
                                      style='float: none; width: 100px; display: inline-block;'
                                      onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                                      onClick="document.user_add_Form.reset(); $('frm_responder_sel').style.display = 'none';"><SPAN
                                        STYLE='float: left;'><?php print get_text("Reset"); ?></SPAN><IMG
                                        STYLE='float: right;' SRC='./images/restore_small.png' BORDER=0></SPAN>
                                <SPAN id='sub_but' CLASS='plain text'
                                      style='float: none; width: 100px; display: inline-block;'
    ...
    if ((isset($_GET)) && (isset($_GET['update'])) && ($_GET['update'] == 'true')) {
        ...
        <FORM METHOD="POST" NAME="api_Form" onSubmit="return validate_key(document.api_Form);"
            ...
            <TABLE BORDER="0" STYLE="margin-left: 100px; margin-top: 40px" ;>
                <TR CLASS="even">
                    <TD CLASS="td_label text" ALIGN='center'>Obtain GMaps API key at
                ...
                <TR CLASS="odd">
                    <TD>
                        <INPUT MAXLENGTH="88" SIZE="88" TYPE="text" NAME="frm_value"
                               VALUE="<?php print $curr_key; ?>"/>
                    </TD>
                </TR>
                <TR CLASS="even">
                    <TD ALIGN='center'>
                        ...
                        <SPAN id='reset_but' CLASS='plain text'
                              style='float: none; width: 100px; display: inline-block;'
                              onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                              onClick="map_cen_reset();"><SPAN
                                STYLE='float: left;'><?php print get_text("Reset"); ?></SPAN><IMG
                                STYLE='float: right;' SRC='./images/restore_small.png' BORDER=0></SPAN>
                        <SPAN id='sub_but' CLASS='plain text'
                              style='float: none; width: 100px; display: inline-block;'
                              onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                              onClick="document.api_Form.submit();"><SPAN
                                STYLE='float: left;'><?php print get_text("Submit"); ?></SPAN><IMG
                                STYLE='float: right;' SRC='./images/submit_small.png' BORDER=0></SPAN>
                    </TD>
                </TR>
...
<DIV style='width: 60%; position: absolute; left: 20%; top: 5%;'>
    ...
    <BR/>
    <BR/>
    <SPAN id='copy_but' CLASS='plain text' style='float: none; display: inline-block; width: 150px;'
          onMouseover='do_hover(this.id);Tip("Click to copy the database dump");'
          onMouseout='do_plain(this.id); UnTip();' onClick="copyit();"><SPAN
            STYLE='float: left;'><?php print get_text("Copy to Clipboard"); ?></SPAN><IMG STYLE='float: right;'
                                                                                          SRC='./images/copy_small.png'
                                                                                          BORDER=0></SPAN>
    <SPAN id='cancel_but' CLASS='plain text' style='float: none; width: 150px; display: inline-block;'
          onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
    ...
    case 'list':
        ...
        if (mysql_affected_rows() > 0) {                    // inventory affected rows
            ...
            <DIV ID='tick_tab'
                 style='position: relative; left: 200px; top: 80px; width: 700px; height: 400px;; overflow-y: auto; border: 1px outset #707070;'>
                <TABLE BORDER=0 style='width: 100%;'>
                    ...
                    while ($row = stripslashes_deep(mysql_fetch_array($result))) {
                        ...
                        <TR CLASS='<?php print $evenodd[$i % 2]; ?>'>
                            ...
                            <TD CLASS='td_label'>
                                <INPUT TYPE='checkbox' NAME='T<?php print $row['id']; ?>'
                                       onClick='document.del_Form.delcount.value++;'>
                            </TD>
                        </TR>
                        <?php
                        $i++;
    ...
    case 'confirm':
        ...
        <DIV STYLE='margin-top:20px; margin-left:100px'><FONT CLASS='warn' SIZE="+1"><B>Please confirm deletions -
            ...
            <FORM METHOD="POST" NAME="del_Form" ACTION="config.php?func=delete&subfunc=do_del">
                ...
                <SPAN id='sub_but' CLASS='plain text' style='float: none; width: 100px; display: inline-block;'
                      onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                      onClick="document.del_Form.submit();"><SPAN
                        STYLE='float: left;'><?php print get_text("Confirm"); ?></SPAN><IMG STYLE='float: right;'
                                                                                            SRC='./images/submit_small.png'
                                                                                            BORDER=0></SPAN>
            </FORM>
            <FORM NAME='can_Form' METHOD="post" ACTION="<?php print basename(__FILE__); ?>"></FORM>
    ...
    <DIV STYLE='margin-left:100px; margin-top:60px;'>
        <FORM NAME='can_Form' METHOD="post" ACTION="<?php print basename(__FILE__); ?>">
            ...
            <BR/>
            <BR/>
            <B>Ticket<?php print $plu; ?> and associated Assigns, Action and <?php print $patient; ?>
                record<?php print $plu; ?> deleted: <U><?php print count($temp); ?></U></B>
            <BR/>
            <BR/>
            <SPAN id='cancel_but' CLASS='plain text' style='float: none; width: 100px; display: inline-block;'
                  onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                  onClick="document.can_Form.submit();"><SPAN
                    STYLE='float: left;'><?php print get_text("Continue"); ?></SPAN><IMG STYLE='float: right;'
                                                                                         SRC='./images/forward_small.png'
                                                                                         BORDER=0></SPAN>
        </FORM>
        </BODY>
        <?php
        ...
        ?>
                    ...
                    switch (get_radio_val(theForm)) {
                        case 0:
                            if (!(theForm.frm_label.value.trim()) == "") {
                                errmsg += "'Label' not used with this option\n";
                            }
                            if (!(theForm.frm_sep.value.trim()) == "") {
                                errmsg += "'Separator' not used with this option\n";
                            }
                            if (!(theForm.frm_number.value.trim()) == "") {
                                errmsg += "'Next number' not used with this option\n";
                            }
                            break;
                        case 1:
                            if (!(theForm.frm_label.value.trim()) == "") {
                            ...
                            if (isNaN(theForm.frm_number.value.trim())) {
                                errmsg += "'Next number' must be numeric\n";
                            } else {
                                if (!(theForm.frm_number.value.trim() > 0)) {
                                    errmsg += "'Next number' must be 1 or greater\n";
                                }
                            }
                            break;
                        case 2:
                            if ((theForm.frm_label.value.trim()) == "") {
                                errmsg += "'Label' required  with this option\n";
                            }
                            if (isNaN(theForm.frm_number.value.trim())) {
                                errmsg += "'Next number' must be numeric\n";
                            } else {
            ...
            <FORM NAME="inc_num_Form" METHOD='post' ACTION="<?php print basename(__FILE__); ?>">
                <TABLE ALIGN="left" BORDER=0 CELLSPACING=0 CELLPADDING=0 STYLE='margin-left:200px;margin-top:100px'>
                    <TR VALIGN="baseline" CLASS='even'>
                        <TH COLSPAN=2 ALIGN='center'><BR/>Automatic Incident Numbers <SPAN
                                STYLE='font-size:75%; font-weight:normal; font-style:italic'>(mouseover styles for hints)</span><BR/><BR/>
                        </TH>
                    </TR>
                    ...
                    <TR VALIGN="baseline" CLASS='odd'>
                        ...
                        <TD>&nbsp;<INPUT TYPE='text' NAME='frm_label' SIZE=16 MAXLENGTH=16
                                         VALUE="<?php print$in_ary[1]; ?>"/></TD>
                    </TR>
                    <TR VALIGN="baseline" CLASS='even'>
                        <TD CLASS='td_label' ALIGN='right'><B>Separator: </B></TD>
                        <TD>&nbsp;<INPUT TYPE='text' NAME='frm_sep' SIZE=4 MAXLENGTH=4
                                         VALUE="<?php print$in_ary[2]; ?>"/>&nbsp;&nbsp;<I> (e.g., dash, slash, space
                                character.)</I></TD>
                    </TR>
                    <TR ALIGN="left" VALIGN="baseline" CLASS='odd'>
                        <TD CLASS='td_label' ALIGN='right'>&nbsp;<B>Next number: </B></TD>
                        <TD>&nbsp;<INPUT TYPE='text' NAME='frm_number' SIZE=8 MAXLENGTH=8
                                         VALUE="<?php print$in_ary[3]; ?>"/></TD>
                    </TR>

                    <TR ALIGN="left" VALIGN="baseline" CLASS='even'>
                        <TD CLASS='td_label' ALIGN='right'>&nbsp;<B>Append <?php print get_text("Incident"); ?>
                                nature: </B></TD>
                        <TD>&nbsp;
                            <SPAN STYLE='margin-left:40px'> No &raquo; <INPUT TYPE='radio' NAME='frm_do_nature'
                                                                              VALUE="0" <?php print $do_nature_n; ?> /></SPAN>
                            <SPAN STYLE='margin-left:40px'> Yes &raquo; <INPUT TYPE='radio' NAME='frm_do_nature'
                                                                               VALUE="1" <?php print $do_nature_y; ?> /></SPAN>
                    ...
                    <TR ALIGN="left" VALIGN="baseline" CLASS='odd'>
                        <TD ALIGN='center' COLSPAN=2>
                            ...
                            <SPAN id='reset_but' CLASS='plain text'
                                  style='float: none; width: 100px; display: inline-block;'
                                  onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                                  onClick="document.inc_num_Form.reset();"><SPAN
                                    STYLE='float: left;'><?php print get_text("Reset"); ?></SPAN><IMG
                                    STYLE='float: right;' SRC='./images/restore_small.png' BORDER=0></SPAN>
                            <SPAN id='sub_but' CLASS='plain text'
                                  style='float: none; width: 100px; display: inline-block;'
                                  onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                                  onClick="validate_inc_num(document.inc_num_Form);"><SPAN
                                    STYLE='float: left;'><?php print get_text("Submit"); ?></SPAN><IMG
                                    STYLE='float: right;' SRC='./images/submit_small.png' BORDER=0></SPAN>
                        </TD>
                    </TR>
        ...
        case 'hints' :                                    // 2/3/11
            ...
            <DIV ID="foo">
                <DIV ID="bar">
                    <SPAN id='cancel_but' CLASS='plain text' style='float: none; width: 100px; display: inline-block;'
                          onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                          onClick="history.back();"><SPAN STYLE='float: left;'><?php print get_text("Cancel"); ?></SPAN><IMG
                            STYLE='float: right;' SRC='./images/cancel_small.png' BORDER=0></SPAN><BR/>
                    <?php // 3/19/11
                    if ((is_administrator()) || (is_super())) {
                        ?>
                        <SPAN id='reset_but' CLASS='plain text'
                              style='float: none; width: 100px; display: inline-block;' onMouseover='do_hover(this.id);'
                              onMouseout='do_plain(this.id);' onClick="document.hints.reset();"><SPAN
                                STYLE='float: left;'><?php print get_text("Reset"); ?></SPAN><IMG STYLE='float: right;'
                                                                                                  SRC='./images/restore_small.png'
                                                                                                  BORDER=0></SPAN><BR/>
                        <SPAN id='sub_but' CLASS='plain text' style='float: none; width: 100px; display: inline-block;'
                              onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                              onClick="document.hints.submit();"><SPAN
                                STYLE='float: left;'><?php print get_text("Apply"); ?></SPAN><IMG STYLE='float: right;'
                                                                                                  SRC='./images/submit_small.png'
                                                                                                  BORDER=0></SPAN><BR/>
                        <?php
            ...
            <DIV ID='to_bottom' style="position:fixed; top:4px; left:50px; height: 12px; width: 10px;"
            ...
            ?>
            <A NAME="bottom"/>
            <IMG SRC="markers/up.png" BORDER=0 onclick="location.href = '#top';" STYLE='margin-left: 50px'
                 TITLE='to top'>
            </BODY>
            </HTML>
        ...
        case 'css_day' :    //	3/15/11
            ...
            ?>
                ...
                <DIV ID="foo">
                    <DIV ID="bar">
                        <SPAN id='try_but' CLASS='plain text' style='float: none; width: 100px; display: inline-block;'
                              onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                              onClick="do_day_color_check();"><SPAN
                                STYLE='float: left;'><?php print get_text("Try Colors"); ?></SPAN><IMG
                                STYLE='float: right;' SRC='./images/colors_small.png' BORDER=0></SPAN><BR/>
                        <SPAN id='cancel_but' CLASS='plain text'
                              style='float: none; width: 100px; display: inline-block;' onMouseover='do_hover(this.id);'
                              onMouseout='do_plain(this.id);' onClick="document.can_Form.submit();"><SPAN
                                STYLE='float: left;'><?php print get_text("Cancel"); ?></SPAN><IMG STYLE='float: right;'
                                                                                                   SRC='./images/cancel_small.png'
                                                                                                   BORDER=0></SPAN><BR/>
                        <?php
                        if ((is_administrator()) || (is_super())) {
                            ...
                            <SPAN id='reset_but' CLASS='plain text'
                                  style='float: none; width: 100px; display: inline-block;'
                                  onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                                  onClick="document.css_day_Form.reset();"><SPAN
                                    STYLE='float: left;'><?php print get_text("Reset"); ?></SPAN><IMG
                                    STYLE='float: right;' SRC='./images/restore_small.png' BORDER=0></SPAN><BR/>
                            <SPAN id='sub_but' CLASS='plain text'
                                  style='float: none; width: 100px; display: inline-block;'
                                  onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                                  onClick="document.css_day_Form.submit();"><SPAN
                                    STYLE='float: left;'><?php print get_text("Apply"); ?></SPAN><IMG
                                    STYLE='float: right;' SRC='./images/submit_small.png' BORDER=0></SPAN><BR/>
                            <?php
                        }
                        ?>
            ...
            ?>
                ...
                <DIV ID="foo">
                    <DIV ID="bar">
                        <SPAN id='try_but' CLASS='plain text' style='float: none; width: 100px; display: inline-block;'
                              onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                              onClick="do_night_color_check();"><SPAN
                                STYLE='float: left;'><?php print get_text("Try Colors"); ?></SPAN><IMG
                                STYLE='float: right;' SRC='./images/colors_small.png' BORDER=0></SPAN><BR/>
                        <SPAN id='cancel_but' CLASS='plain text'
                              style='float: none; width: 100px; display: inline-block;' onMouseover='do_hover(this.id);'
                        ...
                        if ((is_administrator()) || (is_super())) {
                            ...
                            <SPAN id='reset_but' CLASS='plain text'
                                  style='float: none; width: 100px; display: inline-block;'
                                  onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                                  onClick="document.css_night_Form.reset();"><SPAN
                                    STYLE='float: left;'><?php print get_text("Reset"); ?></SPAN><IMG
                                    STYLE='float: right;' SRC='./images/restore_small.png' BORDER=0></SPAN><BR/>
                            <SPAN id='sub_but' CLASS='plain text'
                                  style='float: none; width: 100px; display: inline-block;'
                                  onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                                  onClick="document.css_night_Form.submit();"><SPAN
                                    STYLE='float: left;'><?php print get_text("Apply"); ?></SPAN><IMG
                                    STYLE='float: right;' SRC='./images/submit_small.png' BORDER=0></SPAN><BR/>
                            <?php
                        }
        ...
        <DIV id='mainmenu' class='odd'
             style='position: absolute; left: 20px; top: 50px; max-height: 85%; width: 45%; overflow-x: hidden; overflow-y: auto;'>
            <DIV class='config_heading text' id='gen_settings'
                 style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                <DIV class='config_heading text'>General</DIV>
                <A id='about' class='plain text' style='clear: both; width: 150px;' HREF="#"
                   onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="do_about();">About this
                    version ...</A>
                <?php
                if (!(is_guest())) {
                    if (is_administrator() || is_user() || (get_variable('oper_can_edit') == "1")) {
                        ?>
                        <A id='email_users' class='plain text' style='clear: both; width: 150px;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="do_mail_win()">Email
                            users</A>        <!-- 6/30/09, 3/15/11 -->
                        <A id='contacts' class='plain text' style='clear: both; width: 150px;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('contacts');">Contacts</A>
                        <?php
                    }
                    if (!is_unit()) {
                        ?>
                        <A id='my_profile' class='plain text' style='clear: both; width: 150px;'
                           HREF="config.php?func=profile" onMouseover='do_hover(this.id);'
                           onMouseout='do_plain(this.id);'>Edit My Profile</A>                <!-- 12/1/08 -->
                        <?php
                    }
                }
                if (is_super() || is_administrator()) {    // SHOW MENU BASED ON USER LEVEL
                    ...
                    <A id='add_user' class='plain text' style='clear: both; width: 150px;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       HREF="config.php?func=user&add=true">Add user</A>
                    <A id='edit_settings' class='plain text' style='clear: both; width: 150px;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="config.php?func=settings">Edit
                        Settings</A>
                    <A id='edit_notifies' class='plain text' style='clear: both; width: 150px;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="config.php?func=notify">Add/Edit
                        Notifies</A>
                    <A id='delete_closed' class='plain text' style='clear: both; width: 150px;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="config.php?func=delete">Delete
                        Closed Tickets</A>
                    <A id='alarm_test' class='plain text' style='clear: both; width: 150px;'
                    ...
                    if (($asterisk) && mysql_table_exists("$GLOBALS[mysql_prefix]pin_ctrl")) {        // 7/16
                        ...
                        <A id='pin_cont' class='plain text' style='clear: both; width: 150px;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('pin_ctrl');">PIN Control</A>     <!-- 4/9/10 -->
                        <?php
                    }            // end 'pin_ctrl'
                    if (is_super() || is_admin()) {
                        ?>
                        <A id='wiz_set' class='plain text' style='clear: both; width: 150px;'
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           HREF="config.php?func=wizard_settings">New Incident Wizard Settings</A>
                        <?php
                    }            // end 'wizard Settings'
                    ?>
                    <A id='phpinfo' class='plain text' style='clear: both; width: 150px;'
                    ...
                    ?>
                    <A id='import_mdb' class='plain text' style='clear: both; width: 150px;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="ticketsmdb_import.php">Import
                        Tickets MDB Data</A>
                    <A id='sounds' class='plain text' style='clear: both; width: 150px;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       HREF="config.php?func=sound_settings"><?php echo get_text("Sounds"); ?></A>
            ...
            if (is_administrator() || is_super()) {
                ...
                ?>
                <DIV class='config_heading text' id='files_settings'
                     style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                    <DIV class='config_heading text' style='display: block; clear: both;'>Files</DIV>
                    <A id='ul_file' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick='file_window();'>Upload
                        File</A>
                    <A id='fileman' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="fileman.php">File
                        Manager</A>
                </DIV>
                <DIV class='config_heading text' id='serv_user_settings'
                     style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                    <DIV class='config_heading text' style='display: block; clear: both;'>Service User Portal</DIV>
                    <A id='su_req' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       HREF="./portal/requests.php?from_config=1">Service User Requests</A>
                </DIV>
                <?php
            }
            if (is_super() && (get_variable('use_messaging') != 0)) {
                ?>
                <DIV class='config_heading text' id='msg_settings'
                     style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                    <DIV class='config_heading text' style='display: block; clear: both;'>Messaging</DIV>
                    <A id='msg_set' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       HREF="config.php?func=msg_settings">Messaging Settings</A>
                    <A id='msg_arch' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="msg_archive.php">Message
                        Archiving</A>
                    <A id='white_list' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       onClick="do_Post('known_sources');">Email White List</A>
                    <A id='black_list' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       onClick="do_Post('email_blacklist');">Email Black List</A>
                    <A id='get_msgs' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="get_msgs();">Get all
                        Messages</A>
                    <A id='std_msgs' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="do_Post('std_msgs');">Edit
                        Std Messages</A>
                    <A id='msg_rtxt' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       onClick="do_Post('replacetext');">Msg Text replacement</A>
                    <A id='msg_rtxt_order' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       onClick="do_Post('replacetext_order');">Replacement Text Order</A>
                    <?php
                    if (get_msg_variable('use_autostat') == 1) {        //10/23/12
                        ?>
                        <A class='plain text' style='width: 150px; float: left;' onMouseover='do_hover(this.id);'
                           onMouseout='do_plain(this.id);' HREF="auto_status.php">Edit Auto Status Text</A>
                        <?php
                    }
                    ?>
                </DIV>
            ...
            if (is_super() || is_administrator()) {
                if (is_super() && intval(get_variable('use_mdb')) != 0) {
                    ...
                    <DIV class='config_heading text' id='mdb_section'
                        ...
                        <A id='mdb_set' class='plain text' style='width: 150px; float: left;'
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           HREF="config.php?func=mdb_settings">MDB Settings</A>
                        <A id='memberlist' class='plain text' style='width: 150px; float: left;'
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="member.php">Member
                            List</A>
                        <A id='vehicles' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('vehicles');">Vehicles</A>
                        <A id='vehicle_types' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('vehicle_types');">Vehicle Types</A>
                        <A id='equipment' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('equipment_types');">Equipment</A>
                        <A id='capabilities' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('capability_types');">Capabilities</A>
                        <A id='clothing' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('clothing_types');">Clothing</A>
                        <A id='events' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('events');">Events</A>
                        <A id='event_types' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('event_types');">Event Types</A>
                        <A id='training' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('training_packages');">Training Packages</A>
                        <A id='member_status' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('member_status');">Member Status</A>
                        <A id='member_types' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('member_types');">Member Types</A>
                        <A id='teams' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="do_Post('team');">Teams</A>
                        <A id='defined_fields' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="window.location='revisable_fields.php'">Custom Field Definitions</A>
                        <A id='fieldsets' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('fieldsets');">Fieldsets</A>
                        <A id='bulk_allocations' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="window.location='./bulk_admin/bulk_add_capab.php'">Bulk Allocations</A>
                        <A id='bulk_allocations_selective' class='plain text' style='width: 150px; float: left;'
                           HREF="#" onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="window.location='./bulk_admin/bulk_add_allocation.php'">Selective Bulk
                            Allocations</A>
                    </DIV>
                    <?php
                }
                if (get_variable('use_disp_autostat') == 1) {        //9/10/13
                    ?>
                    <DIV class='config_heading text' id='ad_settings'
                         style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                        <DIV class='config_heading text' style='display: block; clear: both;'>Auto Dispatch Status</DIV>
                        <A id='auto_stat' class='plain text' style='width: 150px; float: left;'
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="auto_disp_status.php">Auto
                            Status Values</A>
                    </DIV>
                    <?php
                }
                ?>
                <DIV class='config_heading text' id='eml_settings'
                     style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                    <DIV class='config_heading text' style='display: block; clear: both;'>Email Lists</DIV>
                    <A id='eml_list' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="do_Post('mailgroup');">Email
                        Lists</A>
                    <A id='eml_list_mem' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       HREF="email_lists.php?func=list">Email List Members</A>
                </DIV>
                <DIV class='config_heading text' id='reg_settings'
                     style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                    <DIV class='config_heading text' style='display: block; clear: both;'>Regions</DIV>
                    <A id='regs_cfg' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       onClick="do_Post('region');"><?php print get_text("Regions"); ?></A>
                    <A id='regs_type' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       onClick="do_Post('region_type');"><?php print get_text("Region"); ?>Type</A>
                    <A id='rst_reg' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       HREF="reset_regions.php">Reset <?php print get_text("Regions"); ?></A>
                    <A id='fix_reg' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       HREF="cleanse_regions.php?func=list">Fix <?php print get_text("Regions"); ?></A>
                </DIV>
                <DIV class='config_heading text' id='disc_settings'
                     style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                    <DIV class='config_heading text' style='display: block; clear: both;'>Display Colors</DIV>
                    <A id='css_day' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="config.php?func=css_day">Edit
                        Day Colors</A>
                    <A id='css_ngt' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       HREF="config.php?func=css_night">Edit Night Colors</A>
                </DIV>
                <DIV class='config_heading text' id='maps_settings'
                     style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                    <DIV class='config_heading text' style='display: block; clear: both;'>Maps Configuration</DIV>
                    <A id='def_map' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="config.php?func=center">Set
                        Default Map</A>
                ...
                <DIV class='config_heading text' id='db_settings'
                    ...
                    <A id='dump_db' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="config.php?func=dump">Dump
                        DB to screen</A>
                    <A id='restore_db' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="db_loader.php">Backup and
                        Restore</A>
                    <A id='rst_db' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="config.php?func=reset">Reset
                        Database</A>
                    <A id='opt_db' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="config.php?func=optimize">Optimize
                        Database</A>
                    <A id='del_indx' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       HREF="show_tables_and_indexes.php">Delete Duplicate Indexes</A>
                    <A id='dedupe_db' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="do_dedupe();">Remove
                        Duplicate DB Entries</A>
                </DIV>
                <?php
            }
            ...
            if (is_administrator() || is_user()) {
                ?>
                <DIV class='config_heading text' id='rc_settings'
                     style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                    <DIV class='config_heading text' style='display: block; clear: both;'>Road Conditions</DIV>
                    <A id='rd_cond' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       onClick="do_Post('conditions');">Conditions Table</A>
                    <?php
                    if (get_roadcondition_types() > 0) {
                        ?>
                        <A id='rd_alerts' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('roadinfo');">Published Alerts</A>
                        <?php
                    }
                    ?>
                </DIV>
            ...
            if ((is_administrator()) || (is_super()) || (get_variable('oper_can_edit') == "1")) {
                ?>
                <DIV class='config_heading text' id='mi'
                     style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                    <DIV class='config_heading text' style='display: block; clear: both;'>Major Incidents<SPAN
                            class='warn'>(Experimental, not fully implemented, for discussion)</SPAN></DIV>
                    <A id='mis' class='plain text' style='width: 150px; float: left;' onMouseover='do_hover(this.id);'
                       onMouseout='do_plain(this.id);' HREF="maj_inc.php">Major Incidents</A>
                    <A id='mi_types' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="do_Post('mi_types');">Major
                        Incident Types</A>
                </DIV>
                <?php
            }
            if (is_super()) {
                ?>
                <DIV class='config_heading text' id='oet_tests'
                     style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                    <DIV class='config_heading text' style='display: block; clear: both;'>Outgoing email Tests</DIV>
                    <A id='tst_smtp' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="do_smtp();">SMTP
                        Mail</A>
                    <A id='tst_native' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="do_native();">Native
                        PHP Mail</A>
                    <DIV class='config_heading text' style='display: block; clear: both;'>Unit Tracking Tests</DIV>
                    <A id='tst_aprs' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="do_test();">APRS</A>
                    <A id='tst_gl' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="do_glat();">Google
                        Latitude</A>
                    <A id='tst_loca' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       onClick="do_locatea();">LocateA</A>
                    <A id='tst_gtrack' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       onClick="do_gtrack();">Gtrack</A>
                    <A id='tst_opengts' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="do_ogts();">Open
                        GTS</A>
                    <A id='tst_tt' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="do_t_tracker();">Internal
                        Tracker</A>
                </DIV>
                <DIV class='config_heading text' id='inc_cfg'
                     style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                    <DIV class='config_heading text'
                         style='display: block; clear: both;'><?php print get_text("Incidents"); ?> Configuration
                    </DIV>
                    <A id='inc_num' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="config.php?func=in_nums">Incident
                        Numbers</A>
                    <A id='inc_types' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="do_Post('in_types');">Incident
                        types</A>
                </DIV>
                <DIV class='config_heading text' id='units_cfg'
                     style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                    <DIV class='config_heading text'
                         style='display: block; clear: both;'><?php print get_text("Units"); ?> Configuration
                    </DIV>
                    <A id='un_status' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       onClick="do_Post('un_status');"><?php print get_text("Unit"); ?> status</A>
                    <A id='un_types' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       onClick="do_Post('unit_types');"><?php print get_text("Unit"); ?> types</A>
                    <A id='rst_unstat' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
            ...
            if (is_administrator() || is_super() || is_user()) {
                ...
                <DIV class='config_heading text' id='warn_locs'
                    ...
                    <A id='warn_loc' class='plain text' style='width: 150px; float: left;'
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="warn_locations.php">Warn
                        Locations</A>
                </DIV>
                <?php
                if (is_super()) {
                    ?>
                    <DIV class='config_heading text' id='capts_etc'
                         style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                        <DIV class='config_heading text' style='display: block; clear: both;'>Captions, Signals, Hints
                            and Places
                        </DIV>
                        <A id='capt_set' class='plain text' style='width: 150px; float: left;'
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           HREF="capts.php">Captions</A></LI></TD>
                        <A id='sigs_set' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="do_Post('codes');">Signals</A>
                        <A id='hints_set' class='plain text' style='width: 150px; float: left;'
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           HREF="config.php?func=hints">Hints</A>
                        <A id='places_set' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('places');">Places</A>
                    </DIV>
                    <?php
                }
            }
            if (is_administrator()) {
                ?>
                <DIV class='config_heading text' id='map_mkup'
                     style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                    <DIV class='config_heading text' style='display: block; clear: both;'>Map Markup</DIV>
                    <A id='mm' class='plain text' style='width: 150px; float: left;' onMouseover='do_hover(this.id);'
                       onMouseout='do_plain(this.id);' HREF="./mmarkup.php">Map Markup</A>
                    <?php
                    if (is_super()) {
                        ?>
                        <A id='mm_cat' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('mmarkup_cats');">MM Categories</A>
                        <?php
                    }
                    ?>
                </DIV>
            ...
            if (is_super()) {                                    // super or admin - 10/28/10
                ?>
                <DIV class='config_heading text' id='modules_cfg'
                     style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                    ...
                    if (mysql_table_exists("$GLOBALS[mysql_prefix]modules")) {
                        ...
                        <A id='mods_cfg' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('modules');">Modules Configuration</A>
                        <A id='mods_del' class='plain text' style='width: 150px; float: left;'
                ...
                <DIV class='config_heading text' id='socket_admin'
                     style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                    <DIV class='config_heading text' style='display: block; clear: both;'>Websocket Server Admin</DIV>
                    <A id='sd_socket' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       onClick="parent.frames['upper'].broadcast('close server',1);">Shut Down Websocket Server</A>
                    <A id='rs_socket' class='plain text' style='width: 150px; float: left;' HREF="#"
                       onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                       onClick="parent.frames['upper'].broadcast('restart server',1);">Restart Websocket Server</A>
                </DIV>
                <?php
                if ($istest) {
                    ?>
                    <DIV class='config_heading text' id='istest_cfg'
                         style='display: inline-block; clear: both; width: 100%; border: 1px inset #707070;'>
                        <DIV class='config_heading text' style='display: block; clear: both;'>Testing</DIV>
                        <A id='test_log' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' onClick="do_Post('log');">Log</A>
                        <A id='test_set' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('settings');">Settings</A>
                        <A id='test_ticks' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('ticket');">Tickets</A>
                        <A id='test_resp' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('responder');"><?php print get_text("Units"); ?></A>
                        <A id='test_act' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('action');">Actions</A>
                        <A id='test_pat' class='plain text' style='width: 150px; float: left;' HREF="#"
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);'
                           onClick="do_Post('patient');">Patients</A>
                        <A id='test_tabs' class='plain text' style='width: 150px; float: left;'
                           onMouseover='do_hover(this.id);' onMouseout='do_plain(this.id);' HREF="tables.php">Tables</A>
                    </DIV>
    ...
    <DIV id='statusBar'
         style='position: fixed; bottom: 5px; left: 5px; width: 100%; height: 50px; background-color: yellow; color: black; display: none;'></DIV>
